...
class ListOfInjured {
    ...
    constructor() {
        ...
        this.jmenoVlozene.setAttribute("placeholder", "Jan");
        ...
        this.prijmeniVlozene.setAttribute("placeholder", "Veselý");
        ...
        this.telefonVlozeny.setAttribute("placeholder", "+420");
        ...
        this.vekVlozeny.setAttribute("placeholder", "32");
    ...
    otevritSkrytFormular() {    //Metoda pro otevreni / skryti formulare + posun dolu seznamu pojistencu
        ...
        this.tlacitkoOtevritFormular.addEventListener("click", () => {
            if (this.tlacitkoOtevritFormular.innerText == "Nový pojištěnec") {
                this.tlacitkoOtevritFormular.innerText = "Skrýt formulář";
            }
            else {
            ...
            setInterval(() => {     //posun objektu formular a sezam pojistencu
                if (this.polohaFormulare < 0 && this.tlacitkoOtevritFormular.innerText == "Skrýt formulář") {
